...
export default function Media(props){
  ...
  const {title, type, imgUrl, rating, _id, user, upVoteMedia, downVoteMedia, likedUsers, dislikedUsers} = props
...
<h3 onClick = {upVoteMedia}>Click to Upvote!</h3>
  </div>
{/* downvote button */}
<div>
<h3>{dislikedUsers.length}</h3>
<h3 onClick = {downVoteMedia}>Click to Downvote!</h3>
</div>
</div>
</div>
